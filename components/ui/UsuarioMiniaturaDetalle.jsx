...
const UsuarioMiniaturaDetalle = ({ cliente }) => {
        ...
        <tr>
          ...
          <td>
            <div className="btn-group ml-auto">
              <Link href="/usuario/[id]" as={`/usuario/${id}`}><a className="btn btn-sm btn-outline-light">Editar</a></Link>
              <button
...
export default UsuarioMiniaturaDetalle;
