    ...
    <div className="col-xl-8 col-lg-8 col-md-12 col-sm-12">
      <div className="card">
        <h5 className="card-header">
          Modificar Registro Usuario <span className="fas fa-user-plus"></span>
        </h5>
            ...
            <fieldset>
              ...
              <div className="form-row">
                ...
                <div className="col-lg-6 col-md-12 col-sm-12 mb-3">
                  ...
                  {errores.apellido && (
                    <p className="alert alert-danger">{errores.apellido}</p>
                  )}
                </div>
              ...
              <legend>Permisos de usuarios</legend>
              <div className="form-row">
                <div className="col-lg-6 col-md-6 col-sm-12 mb-3">
                  ...
                  <label class="custom-control custom-checkbox custom-control-inline">
                    <input type="checkbox" class="custom-control-input" />
                    <span class="custom-control-label">Consultar</span>
                  </label>
                  ...
                  <label class="custom-control custom-checkbox custom-control-inline">
                    <input type="checkbox" class="custom-control-input" />
                    <span class="custom-control-label">Insertar</span>
                  </label>
                </div>

                <div className="col-lg-6 col-md-12 col-sm-12 mb-3">
                  <label htmlFor="sexo">Rol de Usuario</label>
                  <select
                    className="form-control"
                    name="sexo"
                    value={sexo}
                    ...
                    onChange={handleChange}
                  >
                    <option selected value="gerente">
                      Gerente
                    </option>
                    <option value="corredor">Corredor</option>
                    <option value="cobrador">Cobrador</option>
                    <option value="cobrador">Administrador</option>
                  </select>
                </div>
