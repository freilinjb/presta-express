...
const PagosCompletoModal = ({
  ...
  async function registrarPago() {
    ...
    try {
      ...
      prestamo.detallesCuotas[cuotaParcial - 1].valorCuota = (
        Number(prestamo.detallesCuotas[cuotaParcial - 1].valorCuota) -
        Number(pago)
      ).toFixed(2);
      ...
      Swal.fire({
        ...
        if (result.value) {
          Swal.fire("Deleted!", "Preciono Imprimir.", "success");
        } else {
...
export default PagosCompletoModal;
