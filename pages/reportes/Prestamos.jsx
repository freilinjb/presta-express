...
const Prestamos = () => {
  ...
  const handleClickInactivo = () => {
    const filtros = prestamos.filter((prestamo) => {
      return prestamo.estado == "inactivo";
    });
  };
  ...
  const Componente = cargando ? (
    ...
    <div className="">
      <div className="section-block">
        <div className="">
          <h3 className="section-title col-auto p-0">Lista de Prestamos</h3>
          <div
  ...
  const hanbleBuscar = (e) => {
    ...
    if (busqueda.trim()) {
      ...
      const filtro = prestamos.filter((prestamo) => {
        return (
          prestamo.cliente.nombre.toLowerCase() +
          " " +
          prestamo.cliente.apellido.toLowerCase()
        ).includes(buscar);
      });
