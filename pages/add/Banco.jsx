          ...
          <div className="col-xl-8 col-lg-10 col-md-12 col-sm-12">
            <div className="card">
              <h5 className="card-header">
                Registro de cuenta bancaria <span className="fas fa-user-plus"></span>
              </h5>
                      ...
                      <div className="col-lg-6 col-md-12 col-sm-12 mb-3">
                        ...
                        <input
                          ...
                          className={`form-control ${
                            cuenta.length >= 5 ? "is-valid" : "is-invalid"
                          }`}
                          id="cuenta"
                          name="cuenta"
                          value={cuenta}
                        ...
                        />
                        {/* {errores.cuenta && (
                          <p className="alert alert-danger">{errores.cuenta}</p>
                        )} */}
                      </div>
                      <div className="col-lg-6 col-md-12 col-sm-12 mb-3">
                        <label htmlFor="apellido">Banco</label>
                        <input
                          type="text"
                          className={`form-control ${
                            banco.length >= 3 ? "is-valid" : "is-invalid"
                          }`}
                          id="banco"
                          name="banco"
                          placeholder="banco"
                        ...
                        {errores.banco && (
                          <div className="valid-feedback">{errores.banco}</div>
                        )}
                      </div>

                      <div className="col-12">
                        <div className="form-group">
                          <label htmlFor="direccionLaboral">Descripción</label>
                          <textarea
                            className="form-control"
                            name="descripcion"
                            id="descripcion"
                            value={descripcion}
                            onChange={handleChange}
                            placeholder="Descripcion de la entidad financiera"
                            autoComplete="off"
                            rows="2"
                          ></textarea>
                        </div>
